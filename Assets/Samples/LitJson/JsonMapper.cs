    ...
    public class JsonMapper
    {
        ...
        private static object ReadValue(Type inst_type, JsonReader reader)
        {
                ...
                reader.Token == JsonToken.Boolean)
            {
                ...
                if (custom_importers_table.ContainsKey(json_type) && custom_importers_table[json_type].ContainsKey(vt))
                {
                    ImporterFunc importer = custom_importers_table[json_type][vt];
                    return importer(reader.Value);
                }

                // Maybe there's a base importer that works
                if (base_importers_table.ContainsKey(json_type) && base_importers_table[json_type].ContainsKey(vt))
                {
                    ImporterFunc importer = base_importers_table[json_type][vt];
                    return importer(reader.Value);
                }
        ...
        private static unsafe StackObject* JsonToObject(ILIntepreter intp, StackObject* esp, IList<object> mStack,
            CLRMethod method, bool isNewObj)
        {
            ...
            string json = (string) typeof(string).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain,
                mStack));
        ...
        private static unsafe StackObject* JsonToObject2(ILIntepreter intp, StackObject* esp, IList<object> mStack,
            CLRMethod method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = intp.AppDomain;
            StackObject* __ret = ILIntepreter.Minus(esp, 1);
        ...
        private unsafe static StackObject* JsonToObject3(ILIntepreter intp, StackObject* esp, IList<object> mStack,
            CLRMethod method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = intp.AppDomain;
            StackObject* __ret = ILIntepreter.Minus(esp, 1);
