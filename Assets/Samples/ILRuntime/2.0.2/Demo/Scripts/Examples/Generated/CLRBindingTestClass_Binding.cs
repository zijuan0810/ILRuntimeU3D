...
{
    internal static unsafe class CLRBindingTestClass_Binding
    {
        ...
        private static StackObject* DoSomeTest_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
