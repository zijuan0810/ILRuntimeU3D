...
{
    internal static unsafe class UnityEngine_Input_Binding
    {
        ...
        private static StackObject* get_mousePosition_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
