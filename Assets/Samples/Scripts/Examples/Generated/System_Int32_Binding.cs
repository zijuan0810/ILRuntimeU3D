...
{
    internal static unsafe class System_Int32_Binding
    {
        ...
        private static StackObject* ToString_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
