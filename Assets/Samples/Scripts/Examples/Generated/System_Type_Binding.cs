...
{
    internal static unsafe class System_Type_Binding
    {
        ...
        private static StackObject* GetTypeFromHandle_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
