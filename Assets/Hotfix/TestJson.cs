...
namespace Hotfix
{
    public class TestJson
    {
        ...
        private class JsonTestSubClass
        {
        ...
        public static void RunTest()
        {
            ...
            cls.DicTest = new Dictionary<string, JsonTestSubClass> {["11111"] = sub};
            cls.DicTest2 = new Dictionary<string, int> {["111222"] = 333444};
