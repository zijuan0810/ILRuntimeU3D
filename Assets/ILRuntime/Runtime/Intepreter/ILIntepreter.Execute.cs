                                        ...
                                        else
                                        {
                                            ...
                                            if (!((CLRType)t).AssignFieldFromStack(idx, ref obj, this, val, mStack))
                                                ((CLRType)t).SetFieldValue(idx, ref obj,
                                                    t.TypeForCLR.CheckCLRTypes(StackObject.ToObject(val, AppDomain, mStack)));
                                        }
                                    }
                                        break;
                                    case ObjectTypes.StaticFieldReference:
                                                ...
                                                if (!((CLRType)t).AssignFieldFromStack(idx, ref obj, this, val, mStack))
                                                    t.SetStaticFieldValue(idx,
                                                        f.FieldType.CheckCLRTypes(
                                                            CheckAndCloneValueType(StackObject.ToObject(val, domain, mStack), domain)));
                                            }
                                        }
                                        else
                            ...
                            case OpCodeEnum.Stsfld:
                            {
                                ...
                                if (type != null)
                                {
                                    ...
                                    else
                                    {
                                        ...
                                        if (!((CLRType)t).AssignFieldFromStack(idx, ref obj, this, val, mStack))
                                            t.SetStaticFieldValue(idx,
                                                f.FieldType.CheckCLRTypes(CheckAndCloneValueType(StackObject.ToObject(val, domain, mStack),
                                                    domain)));
                                    }
                                }
                                else
                                            ...
                                            else
                                            {
                                                if (ilMethod.DelegateAdapter == null)
                                                {
                                                    ...
                                                    ilMethod.DelegateAdapter =
                                                        domain.DelegateManager.FindDelegateAdapter(null, ilMethod, invokeMethod);
                                                }
                                ...
                                else
                                {
                                    ...
                                    else
                                    {
                                        if (cm.DeclearingType.IsDelegate)
                                        {
                                            ...
                                            if (ilMethod != null)
                                            {
                                                dele = domain.DelegateManager.FindDelegateAdapter((CLRType)cm.DeclearingType,
                                                    (ILTypeInstance)ins, ilMethod);
                                            }
                                            else
                                            {
                                    ...
                                    else
                                    {
                                        ...
                                        else if (type.TypeForCLR.IsEnum)
                                        {
                                            esp = PushObject(objRef, mStack,
                                                Enum.ToObject(type.TypeForCLR, StackObject.ToObject(objRef, AppDomain, mStack)), true);
                                        }
                                        else
                                        {
                                            if (objRef->ObjectType == ObjectTypes.ValueTypeObjectReference)
                                ...
                                if (type != null)
                                {
                                    ...
                                    if (objRef->ObjectType <= ObjectTypes.Double)
                                    {
                                        ...
                                        switch (objRef->ObjectType)
                                        {
                                            case ObjectTypes.Integer:
                                            {
                                                if (tclr != typeof(int) && tclr != typeof(bool) && tclr != typeof(short) &&
                                                    tclr != typeof(byte) && tclr != typeof(ushort) && tclr != typeof(uint))
                                                {
