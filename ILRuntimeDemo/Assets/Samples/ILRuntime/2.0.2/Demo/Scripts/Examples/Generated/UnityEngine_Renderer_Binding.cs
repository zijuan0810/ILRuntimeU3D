...
{
    internal static unsafe class UnityEngine_Renderer_Binding
    {
        ...
        private static StackObject* set_receiveShadows_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
