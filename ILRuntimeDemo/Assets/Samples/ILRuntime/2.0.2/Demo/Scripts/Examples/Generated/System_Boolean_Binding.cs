...
{
    internal static unsafe class System_Boolean_Binding
    {
        ...
        static System.Boolean GetInstance(ILRuntime.Runtime.Enviorment.AppDomain __domain,
            StackObject* ptr_of_this_method, IList<object> __mStack)
        {
            ...
            switch (ptr_of_this_method->ObjectType)
            {
                case ObjectTypes.FieldReference:
                {
                    ...
                    if (instance_of_fieldReference is ILTypeInstance)
                    {
                        instance_of_this_method =
                            (System.Boolean) typeof(System.Boolean).CheckCLRTypes(
                    ...
                    else
                    {
                        ...
                        instance_of_this_method = (System.Boolean) t.GetFieldValue(ptr_of_this_method->ValueLow,
                            instance_of_fieldReference);
                    }
                }
                    break;
                case ObjectTypes.StaticFieldReference:
                {
                    ...
                    {
                        instance_of_this_method =
                            (System.Boolean) ((CLRType) t).GetFieldValue(ptr_of_this_method->ValueLow, null);
                    }
                }
                    break;
        ...
        private static StackObject* ToString_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack,
