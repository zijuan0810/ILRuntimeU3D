...
{
    internal static unsafe class UnityEngine_Time_Binding
    {
        ...
        private static StackObject* get_time_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
