...
public unsafe class Vector2Binder : ValueTypeBinder<Vector2>
{
    ...
    private Vector3Binder Vector3Binder
    {
        get
        {
            if (!vector3BinderGot)
            {
                ...
                if (CLRType.AppDomain.GetType(typeof(Vector3)) is CLRType vector3Type)
    ...
    public override void AssignFromStack(ref Vector2 ins, StackObject* ptr, IList<object> mStack)
    {
    ...
    public override void CopyValueTypeToStack(ref Vector2 ins, StackObject* ptr, IList<object> mStack)
    {
        var v = ILIntepreter.Minus(ptr, 1);
        *(float*) &v->Value = ins.x;
        v = ILIntepreter.Minus(ptr, 2);
    ...
    {
        const BindingFlags flag = BindingFlags.Public | BindingFlags.Instance | BindingFlags.Static |
                                  BindingFlags.DeclaredOnly;
        Type type = typeof(Vector2);
        var args = new[] {typeof(float), typeof(float)};
        MethodBase method = type.GetConstructor(flag, null, args, null);
        appdomain.RegisterCLRMethodRedirection(method, NewVector2);

        args = new[] {typeof(Vector2), typeof(Vector2)};
        ...
        args = new[] {typeof(Vector2), typeof(float)};
        method = type.GetMethod("op_Multiply", flag, null, args, null);
        appdomain.RegisterCLRMethodRedirection(method, Vector2_Multiply);

        args = new[] {typeof(float), typeof(Vector2)};
        method = type.GetMethod("op_Multiply", flag, null, args, null);
        ...
        bool isNewObj)
    {
        ...
        ParseVector2(out var right, intp, ptr, mStack);

        ptr = ILIntepreter.Minus(esp, 2);
        ParseVector2(out var left, intp, ptr, mStack);
    ...
    private StackObject* Vector2_Subtraction(ILIntepreter intp, StackObject* esp, IList<object> mStack,
        CLRMethod method,
        bool isNewObj)
    {
        var ret = ILIntepreter.Minus(esp, 2);
        ...
        bool isNewObj)
    {
        ...
        ptr = ILIntepreter.Minus(esp, 2);
        ParseVector2(out var vec, intp, ptr, mStack);
        ...
        bool isNewObj)
    {
        ...
        var ptr = ILIntepreter.Minus(esp, 1);
        Vector3Binder.ParseVector3(out var vec, intp, ptr, mStack);
    ...
    private static StackObject* Vector2_Equality(ILIntepreter intp, StackObject* esp, IList<object> mStack,
        CLRMethod method,
        bool isNewObj)
    {
        var ret = ILIntepreter.Minus(esp, 2);
    ...
    private static StackObject* Vector2_Inequality(ILIntepreter intp, StackObject* esp, IList<object> mStack,
        CLRMethod method,
        bool isNewObj)
    {
        var ret = ILIntepreter.Minus(esp, 2);
    ...
    private static StackObject* Vector2_Dot(ILIntepreter intp, StackObject* esp, IList<object> mStack, CLRMethod method,
        bool isNewObj)
    {
        var ret = ILIntepreter.Minus(esp, 2);
        var ptr = ILIntepreter.Minus(esp, 1);
    ...
    private static StackObject* Vector2_Distance(ILIntepreter intp, StackObject* esp, IList<object> mStack,
        CLRMethod method,
        bool isNewObj)
    {
        var ret = ILIntepreter.Minus(esp, 2);
    ...
    private static StackObject* Get_Magnitude(ILIntepreter intp, StackObject* esp, IList<object> mStack, CLRMethod method,
        bool isNewObj)
    {
        var ret = ILIntepreter.Minus(esp, 1);
    ...
    private static StackObject* Get_SqrMagnitude(ILIntepreter intp, StackObject* esp, IList<object> mStack, CLRMethod method,
        bool isNewObj)
    {
        var ret = ILIntepreter.Minus(esp, 1);
    ...
    private static void ParseVector2(out Vector2 vec, ILIntepreter intp, StackObject* ptr, IList<object> mStack)
    {
    ...
    private void PushVector2(ref Vector2 vec, ILIntepreter intp, StackObject* ptr, IList<object> mStack)
    {
