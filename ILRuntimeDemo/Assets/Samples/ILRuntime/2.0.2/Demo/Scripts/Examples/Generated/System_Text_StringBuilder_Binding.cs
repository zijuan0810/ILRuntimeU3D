...
{
    internal static unsafe class System_Text_StringBuilder_Binding
    {
        ...
        private static StackObject* AppendLine_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
