...
/// </summary>
public class MinIoC : MinIoC.IScope
{
    /// <summary>
    ...
    /// </summary>
    public MinIoC() => _lifetime = new ContainerLifetime(t => _registeredTypes[t]);
    ...
    {
        return !_registeredTypes.TryGetValue(type, out var registeredType) ? null : registeredType(_lifetime);
    }
        ...
        return (Func<ILifetime, object>) Expression.Lambda(
            Expression.New(constructor, constructor.GetParameters().Select(
                param =>
                {
                    ...
                    return Expression.Convert(Expression.Call(Expression.Constant(resolve.Target), resolve.Method, arg),
                        param.ParameterType);
                })),
            arg).Compile();
    }
...
public static class ContainerExtensions
{
    ...
    /// <param name="minIoC">This container instance</param>
    /// <param name="type">Implementing type</param>
    /// <returns>IRegisteredType object</returns>
    public static MinIoC.IRegisteredType Register<T>(this MinIoC minIoC, Type type) => minIoC.Register(typeof(T), type);
    ...
    /// <param name="minIoC">This container instance</param>
    /// <returns>IRegisteredType object</returns>
    public static MinIoC.IRegisteredType Register<TInterface, TImplementation>(this MinIoC minIoC)
        where TImplementation : TInterface
        => minIoC.Register(typeof(TInterface), typeof(TImplementation));
    ...
    /// <returns>IRegisteredType object</returns>
    public static MinIoC.IRegisteredType Register<T>(this MinIoC minIoC, Func<T> factory)
        => minIoC.Register(typeof(T), () => factory());
    ...
    /// <returns>IRegisteredType object</returns>
    public static MinIoC.IRegisteredType Register<T>(this MinIoC minIoC)
        => minIoC.Register(typeof(T), typeof(T));
    ...
    public static T Resolve<T>(this MinIoC.IScope scope) => (T) scope.GetService(typeof(T));
}